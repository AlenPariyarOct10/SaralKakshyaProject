...
class TestimonialController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.superadmin.testimonial', compact('user'), compact('allTestimonials'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($testimonial) {
            return redirect()->route('superadmin.testimonial.index')->with('success', 'Testimonial created successfully');
        } else {
    ...
    public function update(Request $request)
    {
        ...
        if ($check) {
            return redirect()->route('superadmin.testimonial.index')->with('success', 'Testimonial updated successfully');
        } else {
