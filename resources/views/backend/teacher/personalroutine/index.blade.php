...
@php
    ...
    // Assuming we have a relationship to get teacher's availability
    $availabilities = $teacher->availabilities ?? collect([]);

    // Group availabilities by day
    $availabilityByDay = [];
    foreach ($days as $day) {
        $availabilityByDay[$day] = $availabilities->where('day', $day)->values();
    }
@endphp
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 py-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-lg overflow-hidden transition-all duration-300 hover:shadow-md dark:hover:shadow-xl mb-8">
                ...
                <div class="p-6 md:p-8 dark:text-gray-300">
                    ...
                    <form id="availability-form" action="" method="POST" class="space-y-8">
                        @csrf
                        @method('PUT')
