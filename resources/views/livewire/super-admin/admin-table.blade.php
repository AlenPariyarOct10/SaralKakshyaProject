...
<div class="mb-6 border-b border-gray-200 dark:border-gray-700">
    <ul class="flex flex-wrap -mb-px">
        <li class="mr-2">
            <a wire:click="setTab('all')" class="tab active" data-tab="all">All Admins</a>
        </li>
        <li class="mr-2">
            <a wire:click="setTab('pending')" class="tab" data-tab="pending">Pending Approval <span class="ml-1 text-xs bg-yellow-500 text-white rounded-full px-2 py-0.5">4</span></a>
        </li>
        <li class="mr-2">
            <a wire:click="setTab('approved')" class="tab" data-tab="approved">Approved</a>
        </li>
    </ul>
</div>
...
<div class="card">
    ...
    <!-- All Admins Table -->
    @if($activeTab === 'all')
        <h2 class="text-lg font-semibold mb-2">All Admins</h2>
        @include('components.backend.admin-table', ['admins' => $allAdmins])
    @endif

    <!-- Pending Table -->
    @if($activeTab === 'pending')
        <h2 class="text-lg font-semibold mb-2">Pending Approval</h2>
        @include('components.backend.admin-table', ['admins' => $pendingAdmins])
    @endif

    <!-- Approved Table -->
    @if($activeTab === 'approved')
        <h2 class="text-lg font-semibold mb-2">Approved Admins</h2>
        @include('components.backend.admin-table', ['admins' => $approvedAdmins])
    @endif
</div>
